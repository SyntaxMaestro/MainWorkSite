...
const frequencies: { value: Frequency; label: string; priceSuffix: string; }[] = [
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <p className="mt-6 flex items-baseline gap-x-1">
                <span className="text-4xl font-bold tracking-tight">{tier.price[frequency.value as Frequency]}</span>
